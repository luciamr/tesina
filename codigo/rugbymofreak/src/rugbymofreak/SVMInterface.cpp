...
void SVMInterface::trainModelProb(std::string training_data_file)
{
	...
	const std::string model_file_name = "/home/lucia/data/kth/chris/trained_svm.model";
...
{
	const std::string model_file_name = "/home/lucia/data/TRECVID/svm/model.svm";
	const std::string output_file = "/home/lucia/data/TRECVID/svm/responses.txt";
